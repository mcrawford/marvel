MarvelHeroes <- function(marvelGlm) {
  ...
  ratings <- c(
       ...
       sprintf("%+d", round(coefs["IcemanTRUE"] * 10)),
       sprintf("%+d", round(coefs["IronManTRUE"] * 10)),
       sprintf("%+d", round(coefs["IronheartTRUE"] * 10)),
       sprintf("%+d", round(coefs["MagikTRUE"] * 10)),
       sprintf("%+d", round(coefs["MagnetoTRUE"] * 10)),
       sprintf("%+d", round(coefs["MariaHillTRUE"] * 10)),
       sprintf("%+d", round(coefs["MsMarvelTRUE"] * 10)),
       sprintf("%+d", round(coefs["NebulaTRUE"] * 10)),
       sprintf("%+d", round(coefs["NickFuryTRUE"] * 10)),
       sprintf("%+d", round(coefs["NightcrawlerTRUE"] * 10)),
  ...
  soloRatings = c(
      ...
      sprintf("%+d", round((coefs["IcemanTRUE"] + coefs["IcemanSoloTRUE"]) * 10)),
      ...
      sprintf("%+d", round((coefs["MagnetoTRUE"] + coefs["MagnetoSoloTRUE"]) * 10)),
      sprintf("%+d", round((coefs["MariaHillTRUE"] + coefs["MariaHillSoloTRUE"]) * 10)),
      sprintf("%+d", round((coefs["MsMarvelTRUE"] + coefs["MsMarvelSoloTRUE"]) * 10)),
      sprintf("%+d", round((coefs["NebulaTRUE"] + coefs["NebulaSoloTRUE"]) * 10)),
      sprintf("%+d", round((coefs["NickFuryTRUE"] + coefs["NickFurySoloTRUE"]) * 10)),
      sprintf("%+d", round((coefs["NightcrawlerTRUE"] + coefs["NightcrawlerSoloTRUE"]) * 10)),
